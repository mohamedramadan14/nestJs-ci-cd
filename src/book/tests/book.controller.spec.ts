...
describe("Book Controller", () => {
    ...
    describe("Testing createBook", () => {
        it("should create a book", async () => {
            const result = await bookController.createBook(newBook as CreateBookDto, { user: mockUser });
            expect(result).toEqual(mockedBook);
            expect(bookService.create).toHaveBeenCalled();
            expect(bookService.create).toHaveBeenCalledWith(newBook as Book, mockUser);
    ...
    describe("Testing updateBookById", () => {
        it("should update a book by id", async () => {
            const result = await bookController.updateBook(mockedBook._id, { title: "Updated Book" } as UpdateBookDto);
            expect(result).toEqual(updatedBook);
            expect(bookService.updateById).toHaveBeenCalled();
            expect(bookService.updateById).toHaveBeenCalledWith(mockedBook._id, { title: "Updated Book" } as UpdateBookDto);
